	...
	for _, path := range files {
		t.Run("File: "+path, func(t *testing.T) {
			...
			resource.Test(t, resource.TestCase{
				PreCheck:      func() {},
				IDRefreshName: "kubectl_query.test",
				...
				Steps: []resource.TestStep{
					{
						...
						Check: resource.ComposeAggregateTestCheckFunc(
							...
							resource.TestCheckResourceAttrSet("kubectl_query.test", "yaml_incluster"),
							resource.TestCheckResourceAttrSet("kubectl_query.test", "live_manifest_incluster"),
						),
					},
				},
			})
